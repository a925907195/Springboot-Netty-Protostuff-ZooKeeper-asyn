package com.fjsh.rpc.statistic.enums;


public enum DemoStatisticEnum {
	...
	DemoStatisticEnum(String type, String description){
	...
	// 获得枚举的状态
	public static DemoStatisticEnum getEnumByType(String type){
		
		for (DemoStatisticEnum status : DemoStatisticEnum.values()) {
